    ...
    public class Mazm {
        public Mazm() {
            Opcodes = new Dictionary<string, (KeywordParser, KeywordCompiler, byte)> {
                ...
                { "INC",  (Opcode_1Param_Tokenizer, Reg_Compiler, 0x11) },
                { "DEC",  (Opcode_1Param_Tokenizer, Reg_Compiler, 0x12) },
                { "NOT",  (Opcode_1Param_Tokenizer, Reg_Compiler, 0x13) },
                { "OUT",  (Opcode_2Param_Tokenizer, RegImm_Imm_Compiler, 0x14) },
                ...
                { "OUTR", (Opcode_2Param_Tokenizer, RegImm_Reg_Compiler, 0x1E) },
                ...
                { "CMPIND", (Opcode_2Param_Tokenizer, RegImm_RegAddr_Compiler, 0x23) },
                { "INT",  (Opcode_1Param_Tokenizer, RegImm_Compiler, 0x24) },
                { "TSTIND", (Opcode_2Param_Tokenizer, RegImm_RegAddr_Compiler, 0x25) },
