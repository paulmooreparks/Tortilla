    ...
    public class Decoder : Register {
        ...
        protected void BuildMicrocode() {
            ...
            InstructionArray = new Instruction[] {
                ...
                /* 0x02 */ Instructions.ST_RegVal_RegAddr.Instance,
                ...
                /* 0x10 */ Instructions.TST_RegVal_Reg.Instance,
                /* 0x11 */ Instructions.INC.Instance,
                /* 0x12 */ Instructions.DEC.Instance,
                /* 0x13 */ Instructions.NOT.Instance,
                /* 0x14 */ Instructions.OUT_RegVal_Imm.Instance,
                /* 0x15 */ Exceptions.BadOpcode.Instance, // LNGJMP
                /* 0x16 */ Instructions.JMP_RegVal.Instance,
                /* 0x17 */ Instructions.JZ_RegVal.Instance,
                /* 0x18 */ Instructions.JNZ_RegVal.Instance,
                /* 0x19 */ Instructions.JLT_RegVal.Instance,
                /* 0x1A */ Instructions.JB_RegVal.Instance,
                /* 0x1B */ Instructions.JGT_RegVal.Instance,
                /* 0x1C */ Instructions.JA_RegVal.Instance,
                /* 0x1D */ Instructions.CALL_RegVal.Instance,
                /* 0x1E */ Instructions.OUTR_RegVal_Reg.Instance,
                ...
                /* 0x23 */ Instructions.CMPIND_RegVal_RegAddr.Instance,
                /* 0x24 */ Instructions.INT_RegVal.Instance,
                /* 0x25 */ Instructions.TSTIND_RegVal_RegAddr.Instance,
                /* 0x26 */ Instructions.POP_RegVal.Instance,
                /* 0x27 */ Instructions.RET.Instance,
                /* 0x28 */ Instructions.IRET.Instance,
                /* 0x29 */ Instructions.SETINT.Instance,
                /* 0x2A */ Exceptions.BadOpcode.Instance,
                ...
                /* 0x30 */ Instructions.CLRINT.Instance,
                /* 0x31 */ Instructions.SETCRY.Instance,
                /* 0x32 */ Instructions.CLRCRY.Instance,
                ...
                /* 0x50 */ Instructions.TST_ImmVal_Reg.Instance,
                /* 0x51 */ Exceptions.BadOpcode.Instance,
                /* 0x52 */ Exceptions.BadOpcode.Instance,
                /* 0x53 */ Exceptions.BadOpcode.Instance,
                /* 0x54 */ Exceptions.BadOpcode.Instance, // Instructions.OUT_ImmVal_Imm.Instance,
                /* 0x55 */ Exceptions.BadOpcode.Instance, // Instructions.LNGJMP_ImmVal.Instance,
                /* 0x56 */ Instructions.JMP_ImmVal.Instance,
                /* 0x57 */ Instructions.JZ_ImmVal.Instance,
                /* 0x58 */ Instructions.JNZ_ImmVal.Instance,
                /* 0x59 */ Instructions.JLT_ImmVal.Instance,
                /* 0x5A */ Instructions.JB_ImmVal.Instance,
                /* 0x5B */ Instructions.JGT_ImmVal.Instance,
                /* 0x5C */ Instructions.JA_ImmVal.Instance,
                /* 0x5D */ Instructions.CALL_ImmVal.Instance,
                /* 0x5E */ Instructions.OUTR_ImmVal_Reg.Instance,
                ...
                /* 0x63 */ Instructions.CMPIND_ImmVal_RegAddr.Instance,
                /* 0x64 */ Instructions.INT_ImmVal.Instance,
                /* 0x65 */ Instructions.TSTIND_ImmVal_RegAddr.Instance,
                ...
                /* 0x94 */ Exceptions.BadOpcode.Instance, // OUT_RegAddr_Imm
                /* 0x95 */ Exceptions.BadOpcode.Instance, // LNGJMP_RegAddr
                /* 0x96 */ Instructions.JMP_RegAddr.Instance,
                /* 0x97 */ Instructions.JZ_RegAddr.Instance,
                /* 0x98 */ Instructions.JNZ_RegAddr.Instance,
                /* 0x99 */ Instructions.JLT_RegAddr.Instance,
                /* 0x9A */ Instructions.JB_RegAddr.Instance,
                /* 0x9B */ Instructions.JGT_RegAddr.Instance,
                /* 0x9C */ Instructions.JA_RegAddr.Instance,
                /* 0x9D */ Instructions.CALL_RegAddr.Instance,
                /* 0x9E */ Exceptions.BadOpcode.Instance, // OUTR_RegAddr_Reg
                /* 0x9F */ Exceptions.BadOpcode.Instance, // IN_RegAddr_Reg
                ...
                /* 0xD4 */ Exceptions.BadOpcode.Instance, // OUT_ImmAddr_Imm
                /* 0xD5 */ Exceptions.BadOpcode.Instance, // LNGJMP_ImmAddr
                /* 0xD6 */ Instructions.JMP_ImmAddr.Instance,
                /* 0xD7 */ Instructions.JZ_ImmAddr.Instance,
                /* 0xD8 */ Instructions.JNZ_ImmAddr.Instance,
                /* 0xD9 */ Instructions.JLT_ImmAddr.Instance,
                /* 0xDA */ Instructions.JB_ImmAddr.Instance,
                /* 0xDB */ Instructions.JGT_ImmAddr.Instance,
                /* 0xDC */ Instructions.JA_ImmAddr.Instance,
                /* 0xDD */ Exceptions.BadOpcode.Instance, // CALL_ImmAddr
                /* 0xDE */ Exceptions.BadOpcode.Instance, // OUTR_ImmAddr_Reg
                /* 0xDF */ Exceptions.BadOpcode.Instance, // IN_ImmAddr_Reg
