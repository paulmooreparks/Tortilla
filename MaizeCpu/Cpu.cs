    ...
    public class Decoder : Register {
        ...
        protected void BuildMicrocode() {
            ...
            InstructionArray = new Instruction[] {
                ...
                /* 0x11 */ Instructions.CMPIND_RegVal_RegAddr.Instance,
                /* 0x12 */ Instructions.INT_RegVal.Instance,
                /* 0x13 */ Instructions.TSTIND_RegVal_RegAddr.Instance,
                ...
                /* 0x2A */ Instructions.CLRINT.Instance,
                ...
                /* 0x51 */ Instructions.CMPIND_ImmVal_RegAddr.Instance,
