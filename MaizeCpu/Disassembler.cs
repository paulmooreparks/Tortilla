    ...
    public class Disassembler : Tortilla.IDissasember<UInt64, UInt64> {
        public Disassembler() {
            OpCodes = new Dictionary<int, (string, OpCodeDelegate)> {
                ...
                { 0x10, ("TST", SrcImmReg_DestReg) },
                { 0x50, ("TST", SrcImmReg_DestReg) },
                { 0x90, ("TST", SrcImmReg_DestReg) },
                { 0xD0, ("TST", SrcImmReg_DestReg) },
                { 0x11, ("CMPIND", SrcImmReg_DestReg) },
                { 0x51, ("CMPIND", SrcImmReg_DestReg) },
                { 0x12, ("INT" , UnaryReg) },
                { 0x52, ("INT" , UnaryImm) },
                { 0x13, ("TSTIND" , SrcImmReg_DestReg) },
                { 0x53, ("TSTIND" , SrcImmReg_DestReg) },
